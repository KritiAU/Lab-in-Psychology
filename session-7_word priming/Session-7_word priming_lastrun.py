...
expName = 'Session-7_word priming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/rashmik/Documents/session-7_word priming/Session-7_word priming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        testComponents = [text_2, textbox, submit_text, mouse]
