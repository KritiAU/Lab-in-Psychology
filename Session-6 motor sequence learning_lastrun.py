...
expName = 'Session-6 motor sequence learning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/rashmik/Documents/Session-6_motor sequence learning/Session-6 motor sequence learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('/Users/rashmik/Documents/session-5_visual search task/Kriti_MOL.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        random_2Components = [fixation2, line1_2, line2_2, line3_2, line4_2, probe_2, key_resp_2]
