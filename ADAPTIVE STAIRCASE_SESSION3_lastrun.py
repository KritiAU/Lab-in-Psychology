...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/rashmik/Documents/ADAPTIVE STAIRCASE_SESSION3_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.StairHandler(startVal=10.0, extraInfo=expInfo,
        stepSizes=[2,1,10.5], stepType='lin',
    ...
    for thisTrial in trials:
        ...
        thisExp.addData('key_resp.coss', key_resp.corr)
        # check responses
